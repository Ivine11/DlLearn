...
class MNIST_MLP(object):
    ...
    def build_model(self):  # 建立网络结构
        ...
        # self.fc0 = FullyConnectedLayer(self.hidden2/2, self.out_classes)
    ...
    def load_model(self, param_dir):
        ...
        # self.fc0.load_param(params['w0'], params['b0'])
    ...
    def save_model(self, param_dir):
        ...
        params = {}
        # params['w0'], params['b0'] = self.fc0.save_param()
    ...
    def forward(self, input):  # 神经网络的前向传播
        ...
        # h4 = self.relu0.forward(h3)
        # h4 = self.fc0.forward(h4)
        self.prob = self.softmax.forward(h3)
        return self.prob
    def backward(self):  # 神经网络的反向传播
        # TODO：神经网络的反向传播
        dloss = self.softmax.backward()
        # dh4 = self.fc0.backward(dloss)
        # dh3 = self.relu0.backward(dh4)
    ...
    def train(self):
        print ("train")
        print ("self.train_data.shape[0]", self.train_data.shape[0])
